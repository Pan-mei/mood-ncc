<template>
    <div>
        ...
        <hr/>
        <el-row v-for="subList in moodList" type="flex" justify="center"
        style="margin-top:20px">
            <el-col :span="4"> <img v-bind:src="subList[0].imgUrl"/>
            <div>
   ...
   export default{
       ...
       methods:{
           detailPage:function(title){
               //获取route对象，调用route对象的push方法
               this.$router.push({name:"mood",params:{title:title}});
       }
       }
   }
